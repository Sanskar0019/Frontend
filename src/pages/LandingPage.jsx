  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <section className="bg-black py-16 px-6 text-center">
        ...
        <a
          href="/courses"
          className="bg-indigo-600 hover:bg-indigo-500 px-6 sm:px-8 py-3 rounded text-lg sm:text-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/50"
        >
          Browse Courses
        </a>
      </section>
      ...
      <section id="faculties" className="py-16 px-6 bg-gray-800">
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-indigo-500 mb-10">Meet Our Experts</h2>
      ...
      <section id="reviews" className="py-16 px-6">
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-indigo-500 mb-10">What Our Students Say</h2>
      ...
      <section id="social" className="py-16 px-6 bg-gray-800">
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-indigo-500 mb-10">Follow Us</h2>
        <div className="flex justify-center gap-6 sm:gap-8">
          <a
            href="https://facebook.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-indigo-500 hover:text-indigo-400 text-3xl sm:text-4xl transition-all duration-300"
          >
            <FaFacebook />
          </a>
          <a
